...
cp organizations/fabric-ca/ca.org.provider.com.yaml organizations/fabric-ca/providerOrg/fabric-ca-server-config.yaml
cp organizations/fabric-ca/ca.org.subscriber.com.yaml organizations/fabric-ca/subscriberOrg/fabric-ca-server-config.yaml
cp organizations/fabric-ca/ca.org.regulator.com.yaml organizations/fabric-ca/regulatorOrg/fabric-ca-server-config.yaml
cp organizations/fabric-ca/ca.orderer.com.yaml organizations/fabric-ca/ordererOrg/fabric-ca-server-config.yaml
echo
